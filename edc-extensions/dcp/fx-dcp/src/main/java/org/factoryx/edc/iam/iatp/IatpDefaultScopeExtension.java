...
import org.factoryx.edc.iam.iatp.scope.DefaultScopeExtractor;
...
public class IatpDefaultScopeExtension implements ServiceExtension {
    ...
    @Setting(context = TX_IATP_DEFAULT_SCOPE_PREFIX_CONFIG_ALIAS, value = "The alias of the scope e.g. org.factoryx.vc.type", required = true)
