...
public interface BusinessPartnerDidGroupApiV1 {
    ...
    JsonObject resolve(@Parameter(name = "did", description = "The business partner did") String did);
    ...
    void deleteEntry(@Parameter(name = "did", description = "The business partner number") String did);
