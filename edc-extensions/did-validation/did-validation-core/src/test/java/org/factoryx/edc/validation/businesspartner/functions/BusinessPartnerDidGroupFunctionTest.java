...
class BusinessPartnerDidGroupFunctionTest {
    ...
    private final BusinessPartnerDidGroupFunction<ParticipantAgentPolicyContext> function = new BusinessPartnerDidGroupFunction<>(store, monitor);
