...
import static org.eclipse.tractusx.edc.edr.spi.CoreConstants.FX_POLICY_PREFIX;
...
public class JsonLdExtension implements ServiceExtension {
    ...
    public static final String FX_POLICY_CONTEXT = "https://w3id.org/tractusx/policy/v1.0.0";
