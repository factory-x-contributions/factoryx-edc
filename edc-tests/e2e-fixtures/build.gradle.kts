...
dependencies {
    testFixturesApi(libs.eclipse.tractusx.spi.bdrs.client)
    testFixturesApi(project(":spi:core-spi"))
    testFixturesApi(libs.eclipse.tractusx.edr.spi)
    testFixturesApi(libs.eclipse.tractusx.spi.retirement.evaluation)
    testFixturesApi(libs.eclipse.tractusx.spi.bpn.validation)
    testFixturesApi(libs.eclipse.tractusx.spi.tokenrefresh)
